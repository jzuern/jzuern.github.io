...
Date: 2018-11-24
Slug: rl
Summary: A short introduction into the exciting field of RL
...
We will use the [previously discussed Concept-Math-Code (C-M-C) approach](/blog/2018/cmc/) to gain drive our process of understanding RL.
...
<figure>
  <img src="/images/rl/1.png" alt="The feedback loop of RL (image credit: [[1]](https://lilianweng.github.io/lil-log/2018/02/19/a-long-peek-into-reinforcement-learning.html))">
  <figcaption>The feedback loop of RL (image credit: [[1]](https://lilianweng.github.io/lil-log/2018/02/19/a-long-peek-into-reinforcement-learning.html))</figcaption>
</figure>
...
<figure>
  <img src="/images/rl/2.png" alt="White agent and grey moving walls (hard to see in this static image)">
  <figcaption>White agent and grey moving walls (hard to see in this static image)</figcaption>
</figure>
...
<figure>
  <img src="/images/rl/3.gif" alt="Random actions of untrained agent (sorry about the GIF artefacts)">
  <figcaption>Random actions of untrained agent (sorry about the GIF artefacts)</figcaption>
</figure>
...
<figure>
  <img src="/images/rl/5.png" alt="Rolling average of rewards plotted over the episode number">
  <figcaption>Rolling average of rewards plotted over the episode number</figcaption>
</figure>
