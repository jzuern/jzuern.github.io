...
**Part 3: [Results](/blog/2018/flow3/)**
...
<figure>
  <img src="/images/flow1/1.png" alt="Some smoothed polygons used as training data">
  <figcaption>Some smoothed polygons used as training data</figcaption>
</figure>
...
<figure>
  <img src="/images/flow1/2.png" alt="Fluid velocity in vertical y-direction">
  <figcaption>Fluid velocity in vertical y-direction</figcaption>
</figure>
<figure>
  <img src="/images/flow1/22.png" alt="Fluid velocity in horizontal x-direction">
  <figcaption>Fluid velocity in horizontal x-direction</figcaption>
</figure>
...
<figure>
  <img src="/images/flow1/3.png" alt="Generic Open-FOAM simulation setup. The fluid streams into the simulation domain through the inlet, goes around the obstacle and leaves the simulation box through the outlet.">
  <figcaption>Generic Open-FOAM simulation setup. The fluid streams into the simulation domain through the inlet, goes around the obstacle and leaves the simulation box through the outlet.</figcaption>
</figure>
