...
Date: 2018-09-17
Slug: kalman
Summary: Can we make a 2D robot happy again?
...
<figure>
  <img src="/images/localization/1.png" alt="Robby (big red circle) and two landmarks (smaller red circles)">
  <figcaption>Robby (big red circle) and two landmarks (smaller red circles)</figcaption>
</figure>
...
<figure>
  <img src="/images/localization/2.png" alt="Kalman Filtering. Image grabbed from the [Kalman wiki page](https://upload.wikimedia.org/wikipedia/commons/a/a5/Basic_concept_of_Kalman_filtering.svg): ">
  <figcaption>Kalman Filtering. Image grabbed from the [Kalman wiki page](https://upload.wikimedia.org/wikipedia/commons/a/a5/Basic_concept_of_Kalman_filtering.svg): </figcaption>
</figure>
