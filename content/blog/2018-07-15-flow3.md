...
Date: 2018-07-15
Slug: flow3
Summary: Can we use Neural Networks to predict fluid flow?
...
**Part 1: [A data-driven approach to CFD](/blog/2018/flow1/)**

**Part 2: [Implementation details](/blog/2018/flow2/)**
...
<figure>
  <img src="/images/flow3/1.png" alt="Final validation loss over the number of training samples">
  <figcaption>Final validation loss over the number of training samples</figcaption>
</figure>
...
<figure>
  <img src="/images/flow3/2.png" alt="Validation loss over the number of steps for different types of activation functions">
  <figcaption>Validation loss over the number of steps for different types of activation functions</figcaption>
</figure>
...
<figure>
  <img src="/images/flow3/3.png" alt="Accuracy table for different grid resolutions">
  <figcaption>Accuracy table for different grid resolutions</figcaption>
</figure>
...
<figure>
  <img src="/images/flow3/4.png" alt="Ground truth vector field (obtained with a simulation) and Prediction of the neural net (obtained with the data-driven approach to CFD). But which one is which?">
  <figcaption>Ground truth vector field (obtained with a simulation) and Prediction of the neural net (obtained with the data-driven approach to CFD). But which one is which?</figcaption>
</figure>
...
<figure>
  <img src="/images/flow3/5.png" alt="Absolute error between ground truth and prediction">
  <figcaption>Absolute error between ground truth and prediction</figcaption>
</figure>
...
<figure>
  <img src="/images/flow3/6.png" alt="">
</figure>
| ** |
