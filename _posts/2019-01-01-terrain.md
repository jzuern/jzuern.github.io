...
![Fig. 2: The five terrain types along with a birds-eye-view image and the corresponding spectrogram of the vehicle-terrain interaction sound from the five different terrain classes](https://cdn-images-1.medium.com/max/2798/1*wpeYWwL1DKz0foGVS3qnzA.png)
...
![Fig. 4: Two-dimensional t-SNE visualizations of the audio samples embedded with our SE-R approach after 0, 10, 30, and 90 epochs of training. The color of
the points indicate the corresponding ground truth class. We observe that clusters of embeddings are clearly separable as the training progresses and they
highly correlate with the ground truth terrain class.](https://cdn-images-1.medium.com/max/2752/1*UsfZ6KFFxmfLrCGFs6-4-Q.png)
...
![Fig. 6: Qualitative terrain classification results for a small clip in the dataset.](https://cdn-images-1.medium.com/max/1200/1*D97v_vFaO4xMiCYewfZTKw.gif)
